 ...
 */
    ...
    'reason-ban' => 'Sebab Kena "Ban"',
    'reason-unban' => 'Sebab "Unban"',
    ...
    'two-step-auth' => [
        ...
        'complete-setup' => 'Untuk siapkan TOTP Authentication, sila imbas kod bae di bawah dengan aplikasi Authenrication (Google Authentication, Bitwarden etc) dan masukkan kod TOTP ini do ruangan bawah.',
        'confirm-code' => 'Pastikan Kod TOTP',
        'recovery-code' => 'Time-based One-time Password (TOTP) Recovery Codes',
        'recovery-code-description' => 'Klik butang \'Reveal\' untuk tunjukkan kod recovery untuk akaun anda. Simpan kod ini ditempat selamat kalau ada kemungkinan ansa kehilangan alat TOTP. Jika anda rasa kod ini ada orang lain yang tahu, sila klil . . \'Ubah\' untuk dapatkan kod baru.',
    ],
    ...
    'no-ban' => 'Tiada "ban" dalam pangkalan data untuk pengguna ini!',
    'top-dying' => 'Top Dying',
    'rsskey' => 'RSS Key',
    'restore' => 'Restore',
    'top-dead' => 'Top Dead',
