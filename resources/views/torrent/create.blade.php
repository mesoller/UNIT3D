...
@section('nav-tabs')
    ...
    <li class="nav-tabV2">
        <a class="nav-tab__link" href="{{ route('torrents.pending') }}">
            {{ __('request.pending') }}
        </a>
    </li>
    ...
    <li class="nav-tabV2">
        <a class="nav-tab__link" href="{{ route('subtitles.index') }}">
...
@section('main')
    ...
    >
        {{-- Hero Header --}}
        <div class="upload-hero panelV2">
            <div class="upload-hero__left">
                <div class="upload-hero__icon-wrap">
                    <i class="{{ config('other.font-awesome') }} fa-cloud-arrow-up"></i>
                </div>
                <div class="upload-hero__text">
                    <h1 class="upload-hero__title">{{ __('common.upload') }} {{ __('torrent.torrent') }}</h1>
                    <p class="upload-hero__subtitle">{{ __('torrent.announce-url-desc', ['source' => config('torrent.source')]) }}</p>
                </div>
            </div>
            @if (config('other.upload-guide_url'))
                <a href="{{ config('other.upload-guide_url') }}" class="upload-hero__guide-btn" target="_blank" rel="noopener">
                    <i class="{{ config('other.font-awesome') }} fa-circle-question"></i>
                    Having trouble? See our guide.
                </a>
            @endif
        </div>
        ...
        >
            ...
            <div class="panelV2 upload-section" x-data="{ open: true }">
                <button type="button" class="upload-section__header" @click="open = !open">
                    <div class="upload-section__header-left">
                        <span class="upload-section__icon upload-section__icon--blue">
                            <i class="{{ config('other.font-awesome') }} fa-folder-open"></i>
                        </span>
                        <span class="upload-section__title">{{ __('torrent.upload') ?? 'Upload Files' }}</span>
                    </div>
                    <i class="{{ config('other.font-awesome') }} upload-section__chevron" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                </button>
                <div class="upload-section__body" x-show="open">
                    ...
                    <div class="form__group--horizontal" x-show="cats[cat].type === 'no'">
                        <p class="form__group">
            ...
            <div class="panelV2 upload-section" x-data="{ open: true }">
                <button type="button" class="upload-section__header" @click="open = !open">
                    <div class="upload-section__header-left">
                        <span class="upload-section__icon upload-section__icon--purple">
                            <i class="{{ config('other.font-awesome') }} fa-circle-info"></i>
                        </span>
                        <span class="upload-section__title">Basic Information</span>
                    </div>
                    <i class="{{ config('other.font-awesome') }} upload-section__chevron" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                </button>
                <div class="upload-section__body" x-show="open">
            ...
            {{-- Section: External Database IDs --}}
            <div
                class="panelV2 upload-section"
                x-show="cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'game'"
                x-data="{ open: true }"
            >
                <button type="button" class="upload-section__header" @click="open = !open">
                    <div class="upload-section__header-left">
                        <span class="upload-section__icon upload-section__icon--red">
                            <i class="{{ config('other.font-awesome') }} fa-database"></i>
                        </span>
                        <span class="upload-section__title">External Database IDs</span>
                    </div>
                    <i class="{{ config('other.font-awesome') }} upload-section__chevron" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                </button>
                <div class="upload-section__body" x-show="open">
            ...
            <div class="panelV2 upload-section" x-data="{ open: true }">
                <button type="button" class="upload-section__header" @click="open = !open">
                    <div class="upload-section__header-left">
                        ...
                        <span class="upload-section__title">Description &amp; Keywords</span>
                    </div>
                    <i class="{{ config('other.font-awesome') }} upload-section__chevron" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                </button>
                <div class="upload-section__body" x-show="open">
            ...
            >
                <button type="button" class="upload-section__header" @click="open = !open">
                    <div class="upload-section__header-left">
                        <span class="upload-section__icon upload-section__icon--green">
                            <i class="{{ config('other.font-awesome') }} fa-film"></i>
                        </span>
                        <span class="upload-section__title">Media Information</span>
                    </div>
                    <i class="{{ config('other.font-awesome') }} upload-section__chevron" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                </button>
                <div class="upload-section__body" x-show="open">
...
{{ old('bdinfo') }}</textarea>
            ...
            <div class="panelV2 upload-section" x-data="{ open: true }">
                <button type="button" class="upload-section__header" @click="open = !open">
                    <div class="upload-section__header-left">
                        ...
                        <span class="upload-section__title">Upload Options</span>
                    </div>
                    <i class="{{ config('other.font-awesome') }} upload-section__chevron" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                </button>
                <div class="upload-section__body upload-section__body--checkboxes" x-show="open">
                    <p class="form__group">
            ...
            <div class="upload-actions">
                <button
                    type="submit"
                    class="upload-actions__submit form__button form__button--filled"
                    name="post"
                    value="true"
                    id="post"
                >
